...
def linear(
    ...
    if weight.element_size() > 1:
        ...
        return linear_fp8(x, weight, weight.weight_scale, bias, "fp8", 128)
...
class DeepSeekV3MLP(nn.Module):
    ...
    def __init__(
        self, config: PretrainedConfig, intermediate_size: Optional[int] = None
    ):
        super().__init__()
