...
full_weight = torch.arange(vocab_size * emb_dim, dtype=torch.float32).reshape(vocab_size, emb_dim)
...
for i in range(x.size(0)):
    print(i, x[i].item(), "-> ref:", y_ref[i].tolist(), "sharded_sum:", y_sum[i].tolist())
